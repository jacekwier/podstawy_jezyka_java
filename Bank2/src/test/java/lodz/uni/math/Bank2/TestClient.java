...
import Exceptions.ClientExists;
import Exceptions.NoEnoughMoney;
import Exceptions.WrongName;
import Exceptions.WrongPesel;
import Exceptions.WrongSurname;
...
public class TestClient {
	...
	public void testGetAccounts() {
		...
		assertEquals(inscription, client1.getAccounts());
	}
	...
	public void testGetIdWireOut() {
		assertEquals("1",client1.getIdWireOut().toString());
	}
